...
$('document').ready(function(){
	...
	function bannarComing() {
		...
		$('#bannar_coming').fadeOut('slow').delay(1000).promise().done(function(){
	...
	function balloonsFlying(){
		...
		loopSeven();
		loopEight();
		$('#balloons_flying').fadeOut('slow').delay(1000).promise().done(function(){
	...
	function cakeFadein(){
		$('.cake').fadeIn('slow');
		$('#cake_fadein').fadeOut('slow').delay(3000).promise().done(function(){
